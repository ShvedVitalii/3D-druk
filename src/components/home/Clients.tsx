...
export default function Clients() {
    ...
    async function fetchData() {
      try {
        ...
        if (keyItem?.data) {
          ...
          setData({
            description: raw.description || 'Нам довіряють провідні компанії',
        ...
        console.error('Помилка завантаження замовників:', err);
        setData({
          description: 'Нам довіряють провідні компанії',
          items: [
            { id: '1', name: 'Компанія 1', logo: '/images/clients/logo1.png', order: 1 },
  ...
  if (loading) {
    return <div className="py-16 text-center text-gray-400">Завантаження замовників...</div>;
  }
        ...
        <div className="relative flex items-center">
          ...
          <div className="overflow-hidden mx-12 flex-1">
            {sortedItems.length === 0 ? (
              <div className="text-center py-8 text-gray-400">Наразі немає замовників</div>
            ) : (
              <div
