...
export default function EditPrivacy() {
  ...
  const [content, setContent] = useState({
    ...
    text: 'Тут буде текст Політики конфіденційності. Ви можете редагувати його в адмін-панелі.'
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/admin/content', {
        ...
        body: JSON.stringify({ key: 'privacy', data: content }),
      });
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-[#1a3c34]">📜 Політика конфіденційності</h1>
